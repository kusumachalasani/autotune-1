...
echo "INSTANCES , 50p , 50p_MAXSPIKE , 95p , 95p_MAXSPIKE , 97p , 97p_MAXSPIKE , 99p , 99p_MAXSPIKE , 999p , 999p_MAXSPIKE , 9999p , 9999p_MAXSPIKE , 99999p , 99999p_MAXSPIKE " >> ${RESULTS_DIR_ROOT}/Metrics-quantiles-prom.log
