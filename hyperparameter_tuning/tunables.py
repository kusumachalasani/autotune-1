...
def get_all_tunables():
    ...
    search_space_json = '{"id": "auto123", "application_name": "petclinic-deployment-6d4c8678d4-jmz8x", ' \
                        ...
                        '"double", "upper_bound": 3, "lower_bound": 1, "step": 0.01}, {"name": "memoryRequest", ' \
                        '"value_type": "integer", "upper_bound": 1024, "lower_bound": 270, "step": 1} , {"name": "quarkusthreadpoolcorethreads", ' \
                        '"value_type": "integer", "upper_bound": 24, "lower_bound": 3, "step": 1}, {"name": "quarkusthreadpoolqueuesize", ' \
                        '"value_type": "integer", "upper_bound": 1000, "lower_bound": 0, "step": 1}, {"name": "quarkusdatasourcejdbcminsize", ' \
                        '"value_type": "integer", "upper_bound": 10, "lower_bound": 2, "step": 1}, {"name": "quarkusdatasourcejdbcmaxsize", ' \
                        '"value_type": "integer", "upper_bound": 48, "lower_bound": 20, "step": 1}, {"name": "FreqInlineSize", ' \
                        ...
                        '"value_type": "integer", "upper_bound": 10, "lower_bound": 1, "step": 1}, {"name": "InlineSmallCode", ' \
