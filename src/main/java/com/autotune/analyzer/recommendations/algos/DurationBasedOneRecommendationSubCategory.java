...
public class DurationBasedOneRecommendationSubCategory implements RecommendationSubCategory {
    private String name;
    private int duration;
    private TimeUnit recommendationDurationUnits;

    public DurationBasedOneRecommendationSubCategory(String name, int duration, TimeUnit recommendationDurationUnits) {
        this.name = name;
    ...
    private DurationBasedOneRecommendationSubCategory() {
