...
public class DurationBased1RecommendationSubCategory implements RecommendationSubCategory {
    private String name;
    private int duration;
    private TimeUnit recommendationDurationUnits;

    public DurationBased1RecommendationSubCategory(String name, int duration, TimeUnit recommendationDurationUnits) {
        this.name = name;
    ...
    private DurationBased1RecommendationSubCategory() {
