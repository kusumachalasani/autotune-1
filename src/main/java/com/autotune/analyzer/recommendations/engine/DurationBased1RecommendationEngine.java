...
public class DurationBased1RecommendationEngine implements KruizeRecommendationEngine{
    private static final Logger LOGGER = LoggerFactory.getLogger(DurationBased1RecommendationEngine.class);
    private String name;
    private String key;
    private AnalyzerConstants.RecommendationCategory category;

    public DurationBased1RecommendationEngine() {
        this.name = AnalyzerConstants.RecommendationEngine.EngineNames.DURATION_BASED1;
        this.key = AnalyzerConstants.RecommendationEngine.EngineKeys.DURATION_BASED1_KEY;
    }

    public DurationBased1RecommendationEngine(String name) {
        this.name = name;
    }
